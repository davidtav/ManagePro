  ...
  <header>
    ...
    <nav class="nav nav-pills flex-column flex-sm-row">
      ...
      <div class="d-flex justify-content-center align-items-center w-100 m-2 p-lg-3" id="rotulo-funcao">
        <h1 class="rotuloRequisitante">Requisitante</h1>
      </div>
    </nav>
  </header>
  <!-- place main here -->
    ...
    <div class="container">
      <div class="row justify-content-center align-items-center gap-lg-3">
        <div class="col-sm-4">
          ...
          <form action="../../database/requisitante_processa_login.php" method="post" class="w-100 m-3 p-lg-3">
            ...
            <div class="text-center pt-1 mb-5 pb-1">
              <button class="btn btn-primary btn-lg w-100 m-1" id="btn1">Entrar
              </button>
            </div>
          </form>
          <div class=" text-center pt-1 mb-5 pb-1" id="botaoAlinhamento">
            <button class="btn btn-primary btn-lg w-100  p-lg-2 active" id="btn1" onclick="alertaPadrao01()">esqueceu sua senha?
            </button>
          </div>
        </div>
      </div>
