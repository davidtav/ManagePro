...
<body>
    ...
    <div class="container">
      <div class="row justify-content-center align-items-center gap-lg-3">
        <div class="col-sm-4">
          ...
          <form action="../../database/adm_processa_login.php" method="post" class="w-100 m-3 p-lg-3">
            ...
            <div class="text-center pt-1 mb-5 pb-1">
              <button class="btn btn-primary btn-lg w-100 m-1" id="btn2">Entrar
              </button>
            </div>
          </form>
          <div class=" text-center pt-1 mb-5 pb-1" id="botaoAlinhamento">
             <button class="btn btn-primary btn-lg w-100  p-lg-2 active" id="btn2" onclick="alertaPadrao01()">esqueceu sua senha?
            </button>
            </a>
          </div>
  ...
  <script>
    function alertaPadrao01() {
      alert("Por favor, entre em contato com o administrador, através do email: changepassword@managepro.dev ");
    };
  </script>
