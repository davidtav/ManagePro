...
$nome_requisitante= $_POST['nome_req'];
...
mysqli_query($conexao, "INSERT INTO `requisitante`(`id_requisitante`, `nome_requisitante`, `telefone`,`email`,`senha`,`foto` ) VALUES (default, '$nome_requisitante','$telefone','$email','$hash','$foto')");
...
<DOCTYPE html>
    ...
    <body>
        ...
        <br>
        <a href="../administrador/form_requisitante.php">Voltar para cadastro de novo requisitante</a>
