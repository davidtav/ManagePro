...
<head>
    ...
    <title>Cadastro de Requisitantes</title>
...
<body>
    ...
    <section class="colaborador">
        <form action="incluir_requisitante.php" enctype="multipart/form-data" method="POST">

        <label>Nome do requisitante:
            <input type="text" name="nome_req" required>
            </label>
        <label>Telefone:
            <input type="text" name="fone_req" required><br>
        </label>
        <label>E-mail:        
            <input type="email" name="email_req" required><br>
        </label>
        <label>Senha:
            <input type="password" name="senha_req" required><br>
        </lable>
