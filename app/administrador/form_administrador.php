...
<body>
    ...
    <section class="colaborador">
        <form action="incluir_administrador.php" enctype="multipart/form-data" method="POST">

        <label>Nome do administrador:
            <input type="text" name="nome_admin" required>
            </label>
        <label>Telefone:
            <input type="text" name="fone_admin" required><br>
        </label>
        <label>E-mail:        
            <input type="email" name="email_admin" required><br>
        </label>
        <label>Senha:
            <input type="password" name="senha_admin" required><br>
        </lable>
