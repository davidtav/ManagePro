...
$dados=mysqli_query($conexao, "SELECT * FROM requisitante");
$lista = $dados;
...
<head>
   ...
   <script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
    ...
    <title>listagem de requisitantes</title>
</head>
...
<a href="admin_dashboard.php"><img src="../../public/imagens/manage_pro_big.jpg" id="logo"></a>
            ...
            <div class="menu_admin">
                <a href="form_requisitante.php">Novo Requisitante</a>
    ...
    <thead id="tabela">
        ...
        <?php foreach ($lista as $item) { ?>
                <td><?= $item["id_requisitante"] ?></td>
                <td><?= $item["nome_requisitante"] ?></td>
                <td><?= $item["telefone"] ?></td>
                <td><?= $item["email"] ?></td>
                ...
                <td align="center" width="15"><a href="editar_requisitante.php?id=<?= $item["id_requisitante"] ?>"><i class="fa fa-pencil"></i></a>
                <span align="center" width="15" onClick="verifica('<?=$item["id_requisitante"] ?>')"> <a href="#"><i class="fa fa-trash"></i></a></td>
    ...
    <script>
        function verifica(id) {
            if (confirm("Tem certeza que deseja Excluir permanentemente este requisitante?")) {
                window.location = "excluir_requisitante.php?id_requisitante=" + id;
            }
        }
    </script>
