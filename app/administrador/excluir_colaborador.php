...
if(isset($_GET['id_colaborador']) && is_numeric($_GET['id_colaborador'])){
    //o intval vai converter o ID em número inteiro -- considera parte inteira.
    $recebeId = intval($_GET['id_colaborador']); 

    mysqli_query($conexao, "DELETE FROM `colaborador` WHERE id_colaborador=$recebeId");
